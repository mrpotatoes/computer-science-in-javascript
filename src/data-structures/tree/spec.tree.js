...
describe('[Data Structure] Tree', () => {
  it.skip('TreeDS() root should be null', () => {
  ...
  it.skip('Should not be able to remove from an empty tree.', () => {
    const tree = new TreeDS()
  ...
  it.skip('add(1...2) and should not be able to reset root node', () => {
    const tree = new TreeDS()
    tree.add('thing')
  ...
  it.skip('add(1...8) remove(cto), remove(cfo), remove(ceo), ', () => {
    const tree = new TreeDS()
    tree.add('ceo')
    tree.add('cto', 'ceo')
    tree.add('cfo', 'ceo')
  ...
  it.skip('add(1...8) contains(ceo), ', () => { })

  it.skip('add(1...8) findBFS(ceo), ', () => { })

  it.skip('add(1...8) preOrder(ceo), ', () => { })

  it.skip('add(1...8) postOrder(ceo), ', () => { })

  it.skip('add(1...8) traverseDFS(ceo), ', () => { })

  it.skip('add(1...8) traverseBFS(ceo), ', () => { })

  it.skip('add(1...8) getTree(ceo), ', () => { })
})
